...
async function grantAppliedTo(req: Request, res: Response) {
    ...
    if (chain === undefined) {
        ...
        try {
            const data = await work(OnChainEvent.GrantAppliedTo, chain, { workspaceId })
